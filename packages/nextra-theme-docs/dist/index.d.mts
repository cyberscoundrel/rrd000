...
declare function useHWContext(): HWContextType;
...
export { Bleed, Collapse, type PartialDocsThemeConfig as DocsThemeConfig, type HWContextButtonType, Link, LocaleSwitch, Navbar, NotFoundPage, ServerSideErrorPage, SkipNavContent, SkipNavLink, ThemeSwitch, Layout as default, useConfig, useHWContext };
