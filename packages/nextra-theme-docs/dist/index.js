...
// src/contexts/helpwincontext.tsx
import { createContext as createContext5, useState as useState3, useContext as useContext5 } from "react";
import { jsx as jsx3 } from "react/jsx-runtime";
var HWContext = createContext5({
  mdDir: "md/test",
  buttonState: [],
  setMDDir: () => {
  },
...
var HWContextProvider = ({ children }) => {
  const [hwMDDir, setHWMDDir] = useState3("md/test");
  const [hwButtonState, setHWButtonState] = useState3([]);
  const val = { mdDir: hwMDDir, buttonState: hwButtonState, setMDDir: setHWMDDir, setButtonState: setHWButtonState };
  return /* @__PURE__ */ jsx3(HWContext.Provider, { value: val, children });
};
function useHWContext() {
  return useContext5(HWContext);
}
  ...
  if (newWindow) {
    return /* @__PURE__ */ jsxs(
      ...
      __spreadProps(__spreadValues({
        ...
        children: [
          children,
          /* @__PURE__ */ jsx4("span", { className: "nx-sr-only nx-select-none", children: " (opens in a new tab)" })
        ]
      })
    );
  }
  if (!href) {
    return /* @__PURE__ */ jsx4("a", __spreadProps(__spreadValues({ ref: forwardedRef }, props), { children }));
  }
  if (nextVersion > 12 || config.newNextLinkBehavior) {
    return /* @__PURE__ */ jsx4(NextLink, __spreadProps(__spreadValues({ ref: forwardedRef, href }, props), { children }));
  }
  return /* @__PURE__ */ jsx4(NextLink, { href, passHref: true, children: /* @__PURE__ */ jsx4("a", __spreadProps(__spreadValues({ ref: forwardedRef }, props), { children })) });
});
...
function renderComponent(ComponentOrNode, props) {
  ...
  return /* @__PURE__ */ jsx5(ComponentOrNode, __spreadValues({}, props));
}
...
function Banner() {
  ...
  return /* @__PURE__ */ jsxs2(Fragment, { children: [
    /* @__PURE__ */ jsx6("script", { dangerouslySetInnerHTML: { __html: hideBannerScript } }),
    /* @__PURE__ */ jsxs2(
      "div",
      {
        className: cn(
        ...
        children: [
          /* @__PURE__ */ jsx6("div", { className: "nx-w-full nx-truncate nx-px-4 nx-text-center nx-font-medium nx-text-sm", children: renderComponent(banner.text) }),
          banner.dismissible && /* @__PURE__ */ jsx6(
            "button",
            {
              type: "button",
              ...
              children: /* @__PURE__ */ jsx6(XIcon, { className: "nx-mx-auto nx-h-4 nx-w-4" })
            }
          )
        ]
      }
...
function Breadcrumb({
  ...
  return /* @__PURE__ */ jsx8("div", { className: "nextra-breadcrumb nx-mt-1.5 nx-flex nx-items-center nx-gap-1 nx-overflow-hidden nx-text-sm nx-text-gray-500 dark:nx-text-gray-400 contrast-more:nx-text-current", children: activePath.map((item, index) => {
    const isLink = !item.children || item.withIndexPage;
    const isActive = index === activePath.length - 1;
    return /* @__PURE__ */ jsxs3(Fragment2, { children: [
      index > 0 && /* @__PURE__ */ jsx8(ArrowRightIcon, { className: "nx-w-3.5 nx-shrink-0" }),
      /* @__PURE__ */ jsx8(
        "div",
        {
          className: cn3(
          ...
          title: item.title,
          children: isLink && !isActive ? /* @__PURE__ */ jsx8(Anchor, { href: item.route, children: item.title }) : item.title
        }
      )
...
var HighlightMatches = memo(function HighlightMatches2({
  ...
  regexp.lastIndex !== 0) {
    ...
    content.push(
      before,
      /* @__PURE__ */ jsx10("span", { className: "nx-text-primary-600", children: after }, result.index)
    );
...
import { Fragment as Fragment4, useCallback as useCallback2, useEffect as useEffect2, useRef as useRef4, useState as useState4 } from "react";
...
// src/components/flexsearch.tsx
import { Fragment as Fragment6, jsx as jsx13, jsxs as jsxs7 } from "react/jsx-runtime";
var indexes = {};
      ...
      for (let j = 0; j < sectionResults.length; j++) {
        ...
        results2.push({
          ...
          children: /* @__PURE__ */ jsxs7(Fragment6, { children: [
            /* @__PURE__ */ jsx13("div", { className: "nx-text-base nx-font-semibold nx-leading-5", children: /* @__PURE__ */ jsx13(HighlightMatches, { match: search2, value: title }) }),
            content && /* @__PURE__ */ jsx13("div", { className: "excerpt nx-mt-1 nx-text-sm nx-leading-[1.35rem] nx-text-gray-600 dark:nx-text-gray-400 contrast-more:dark:nx-text-gray-50", children: /* @__PURE__ */ jsx13(HighlightMatches, { match: search2, value: content }) })
          ] })
        });
...
function Select({
  ...
  return /* @__PURE__ */ jsx14(Listbox, { value: selected, onChange, children: ({ open }) => /* @__PURE__ */ jsxs8(
    Listbox.Button,
    {
      ref: trigger,
      title,
      ...
      children: [
        selected.name,
        /* @__PURE__ */ jsx14(Portal, { children: /* @__PURE__ */ jsx14(
          Transition2,
          {
            ref: container,
            show: open,
            ...
            children: options.map((option) => /* @__PURE__ */ jsxs8(
              Listbox.Option,
              {
                ...
                children: [
                  option.name,
                  option.key === selected.key && /* @__PURE__ */ jsx14("span", { className: "nx-absolute nx-inset-y-0 nx-flex nx-items-center ltr:nx-right-3 rtl:nx-left-3", children: /* @__PURE__ */ jsx14(CheckIcon, {}) })
                ]
              },
              option.key
            ))
    ...
    Select,
    {
      ...
      selected: {
        ...
        name: /* @__PURE__ */ jsxs9("span", { className: "nx-flex nx-items-center nx-gap-2", children: [
          ...
          /* @__PURE__ */ jsx15("span", { className: lite ? "nx-hidden" : "", children: selected == null ? void 0 : selected.text })
        ] })
      },
...
function Footer({ menu }) {
  ...
  return /* @__PURE__ */ jsxs10("footer", { className: "nx-bg-gray-100 nx-pb-[env(safe-area-inset-bottom)] dark:nx-bg-neutral-900 print:nx-bg-transparent", children: [
    ...
    /* @__PURE__ */ jsx16("hr", { className: "dark:nx-border-neutral-800" }),
    /* @__PURE__ */ jsx16(
      "div",
      {
        className: cn9(
...
function Head() {
  ...
  return /* @__PURE__ */ jsxs11(Fragment7, { children: [
    ...
    /* @__PURE__ */ jsxs11(NextHead, { children: [
      config.faviconGlyph ? /* @__PURE__ */ jsx17(
        "link",
        {
          rel: "icon",
      ...
      children: [
        prev && /* @__PURE__ */ jsxs12(
          Anchor,
          {
            ...
            children: [
              /* @__PURE__ */ jsx18(ArrowRightIcon2, { className: cn10(classes.icon, "ltr:nx-rotate-180") }),
              prev.title
            ]
          }
        ),
        next2 && /* @__PURE__ */ jsxs12(
          Anchor,
          {
            ...
            children: [
              next2.title,
              /* @__PURE__ */ jsx18(ArrowRightIcon2, { className: cn10(classes.icon, "rtl:nx-rotate-180") })
            ]
          }
        )
      ]
...
function NavbarMenu({
  ...
  return /* @__PURE__ */ jsx19("div", { className: "nx-relative nx-inline-block", children: /* @__PURE__ */ jsxs13(Menu, { children: [
    /* @__PURE__ */ jsx19(
      Menu.Button,
      {
        className: cn11(
    ...
    /* @__PURE__ */ jsx19(
      Transition3,
      {
        ...
        leaveFrom: "nx-opacity-100",
        leaveTo: "nx-opacity-0",
        children: /* @__PURE__ */ jsx19(Menu.Items, { className: "nx-absolute nx-right-0 nx-z-20 nx-mt-1 nx-max-h-64 nx-min-w-full nx-overflow-auto nx-rounded-md nx-ring-1 nx-ring-black/5 nx-bg-white nx-py-1 nx-text-sm nx-shadow-lg dark:nx-ring-white/20 dark:nx-bg-neutral-800", children: Object.entries(items || {}).map(([key, item]) => {
          var _a;
          return /* @__PURE__ */ jsx19(Menu.Item, { children: /* @__PURE__ */ jsx19(
            Anchor,
            {
...
function Navbar({ flatDirectories, items }) {
  ...
  return /* @__PURE__ */ jsxs13("div", { className: "nextra-nav-container nx-sticky nx-top-0 nx-z-20 nx-w-full nx-bg-transparent print:nx-hidden", children: [
    ...
    /* @__PURE__ */ jsxs13("nav", { className: "nx-mx-auto nx-flex nx-h-[var(--nextra-navbar-height)] nx-max-w-[90rem] nx-items-center nx-justify-end nx-gap-2 nx-pl-[max(env(safe-area-inset-left),1.5rem)] nx-pr-[max(env(safe-area-inset-right),1.5rem)]", children: [
      config.logoLink ? /* @__PURE__ */ jsx19(
        Anchor,
        {
      ...
      ) : /* @__PURE__ */ jsx19("div", { className: "nx-flex nx-items-center ltr:nx-mr-auto rtl:nx-ml-auto", children: renderComponent(config.logo) }),
      items.map((pageOrMenu) => {
        ...
        return /* @__PURE__ */ jsxs13(
          Anchor,
          {
            ...
            children: [
              /* @__PURE__ */ jsx19("span", { className: "nx-absolute nx-inset-x-0 nx-text-center", children: page.title }),
              /* @__PURE__ */ jsx19("span", { className: "nx-invisible nx-font-medium", children: page.title })
            ]
          },
          href
        );
      ...
      config.project.link ? /* @__PURE__ */ jsx19(
        Anchor,
        {
      ...
      config.chat.link ? /* @__PURE__ */ jsx19(
        Anchor,
        {
          className: "nx-p-2 nx-text-current",
...
var OnFocusItemContext = createContext6(
  null
);
...
var Folder = memo2(function FolderInner(props) {
  ...
  return /* @__PURE__ */ jsx22(FolderLevelContext.Provider, { value: level + 1, children: /* @__PURE__ */ jsx22(FolderImpl, __spreadValues({}, props)) });
});
var classes3 = {
  link: cn12(
...
function FolderImpl({ item, anchors }) {
  ...
  return /* @__PURE__ */ jsxs14("li", { className: cn12({ open, active }), children: [
    ...
    /* @__PURE__ */ jsx22(Collapse, { className: "ltr:nx-pr-0 rtl:nx-pl-0 nx-pt-1", isOpen: open, children: Array.isArray(item.children) ? /* @__PURE__ */ jsx22(
      Menu2,
      {
  ...
  return /* @__PURE__ */ jsx22(
    "li",
    {
      ...
      children: title ? renderComponent(config.sidebar.titleComponent, {
        ...
        type: "separator",
        route: ""
      }) : /* @__PURE__ */ jsx22("hr", { className: "nx-mx-2 nx-border-t nx-border-gray-200 dark:nx-border-primary-100/10" })
    }
  );
}
function File({
  ...
  const onFocus = useContext6(OnFocusItemContext);
  const active = item.route && [route, route + "/"].includes(item.route + "/");
  const activeAnchor = useActiveAnchor();
  const { setMenu } = useMenu();
  const config = useConfig();
  if (item.type === "separator") {
    return /* @__PURE__ */ jsx22(Separator, { title: item.title });
  }
  return /* @__PURE__ */ jsxs14("li", { className: cn12(classes3.list, { active }), children: [
    ...
    active && anchors.length > 0 && /* @__PURE__ */ jsx22(
      "ul",
      {
        className: cn12(
          classes3.list,
        ...
        children: anchors.map(({ id, value }) => {
          var _a;
          return /* @__PURE__ */ jsx22("li", { children: /* @__PURE__ */ jsx22(
            "a",
            {
              href: `#${id}`,
              className: cn12(
...
function Menu2({
  ...
  return /* @__PURE__ */ jsx22("ul", { className: cn12(classes3.list, className), children: directories.map(
    (item) => !onlyCurrentDocs || item.isUnderCurrentDocsTree ? item.type === "menu" || item.children && (item.children.length || !item.withIndexPage) ? /* @__PURE__ */ jsx22(Folder, { item, anchors }, item.name) : /* @__PURE__ */ jsx22(File, { item, anchors }, item.name) : null
  ) });
}
function Sidebar({
  docsDirectories,
  ...
  return /* @__PURE__ */ jsxs14(Fragment8, { children: [
    includePlaceholder && asPopover ? /* @__PURE__ */ jsx22("div", { className: "max-xl:nx-hidden nx-h-0 nx-w-64 nx-shrink-0" }) : null,
    /* @__PURE__ */ jsx22(
      "div",
      {
        className: cn12(
    ...
    /* @__PURE__ */ jsxs14(
      "aside",
      {
        ...
        ref: containerRef,
        children: [
          /* @__PURE__ */ jsx22("div", { className: "nx-px-4 nx-pt-4 md:nx-hidden", children: renderComponent(config.search.component, {
            directories: flatDirectories
          }) }),
          /* @__PURE__ */ jsx22(FocusedItemContext.Provider, { value: focused, children: /* @__PURE__ */ jsx22(
            OnFocusItemContext.Provider,
            {
              ...
              children: /* @__PURE__ */ jsxs14(
                "div",
                {
                  ...
                  ref: sidebarRef,
                  children: [
                    (!asPopover || !showSidebar) && /* @__PURE__ */ jsx22(Collapse, { isOpen: showSidebar, horizontal: true, children: /* @__PURE__ */ jsx22(
                      Menu2,
                      {
                    ...
                    mounted && window.innerWidth < 768 && /* @__PURE__ */ jsx22(
                      Menu2,
                      {
          ...
          hasMenu && /* @__PURE__ */ jsxs14(
            "div",
            {
              ...
              children: [
                ...
                config.darkMode && /* @__PURE__ */ jsx22(
                  "div",
                  {
                ...
                config.sidebar.toggleButton && /* @__PURE__ */ jsx22(
                  "button",
                  {
                    ...
                    children: /* @__PURE__ */ jsx22(ExpandIcon, { isOpen: showSidebar })
                  }
                )
              ]
            }
...
var SkipNavContent = forwardRef3(
  function(_a, forwardedRef) {
    ...
    return /* @__PURE__ */ jsx23("div", __spreadProps(__spreadValues({}, props), { ref: forwardedRef, id: id || DEFAULT_ID }));
  }
);
    ...
    Select,
    {
      ...
      selected: {
        ...
        name: /* @__PURE__ */ jsxs15("div", { className: "nx-flex nx-items-center nx-gap-2 nx-capitalize", children: [
          /* @__PURE__ */ jsx24(IconToUse, {}),
          /* @__PURE__ */ jsx24("span", { className: lite ? "md:nx-hidden" : "", children: mounted ? options[theme2] : options.light })
        ] })
      }
    }
  );
...
function BackToTop({ className }) {
  ...
  return /* @__PURE__ */ jsxs16(
    "button",
    {
      ...
      children: [
        "Scroll to top",
        /* @__PURE__ */ jsx25(ArrowRightIcon5, { className: "-nx-rotate-90 nx-w-3.5 nx-h-3.5 nx-border nx-rounded-full nx-border-current" })
      ]
    }
  );
}
    ...
    "div",
    {
      ...
      children: [
        hasHeadings && /* @__PURE__ */ jsxs17(Fragment9, { children: [
          /* @__PURE__ */ jsx26("p", { className: "nx-mb-4 nx-font-semibold nx-tracking-tight", children: renderComponent(config.toc.title) }),
          /* @__PURE__ */ jsx26("ul", { children: items.map(({ id, value, depth }) => {
            var _a2, _b, _c, _d;
            return /* @__PURE__ */ jsx26("li", { className: "nx-my-2 nx-scroll-my-6 nx-scroll-py-6", children: /* @__PURE__ */ jsx26(
              "a",
              {
                href: `#${id}`,
                className: cn15(
        ...
        hasMetaInfo && /* @__PURE__ */ jsxs17(
          "div",
          {
            ...
            children: [
              config.feedback.content ? /* @__PURE__ */ jsx26(
                Anchor,
                {
              ...
              config.toc.backToTop && /* @__PURE__ */ jsx26(BackToTop, { className: linkClassName })
            ]
          }
        )
      ]
...
// src/components/helpwin.tsx
import useSWR from "swr";
import parse, { attributesToProps, Element } from "html-react-parser";

// ../../node_modules/.pnpm/react-modal-image@2.6.0/node_modules/react-modal-image/es/index.js
import React5, { Component as Component4 } from "react";

// ../../node_modules/.pnpm/react-modal-image@2.6.0/node_modules/react-modal-image/es/Lightbox.js
import React4, { Component as Component3 } from "react";

// ../../node_modules/.pnpm/react-modal-image@2.6.0/node_modules/react-modal-image/es/styles.js
...
// ../../node_modules/.pnpm/react-modal-image@2.6.0/node_modules/react-modal-image/es/Header.js
import React2 from "react";

// ../../node_modules/.pnpm/react-modal-image@2.6.0/node_modules/react-modal-image/es/icons.js
...
var SpinnerIcon2 = function SpinnerIcon3() {
  return /* @__PURE__ */ React.createElement("svg", {
    fill: "#ffffff",
    height: "48",
    viewBox: "0 0 24 24",
...
var Header = function Header2(_ref) {
  ...
  }, enableDownload && /* @__PURE__ */ React2.createElement("a", {
    href: image,
    download: true,
    onClick: crossOriginDownload(image)
  }, /* @__PURE__ */ React2.createElement(DownloadIcon, null)), enableZoom && /* @__PURE__ */ React2.createElement("a", {
    onClick: toggleZoom
  }, zoomed ? /* @__PURE__ */ React2.createElement(ZoomOutIcon, null) : /* @__PURE__ */ React2.createElement(ZoomInIcon, null)), enableRotate && /* @__PURE__ */ React2.createElement("a", {
    onClick: toggleRotate
  }, /* @__PURE__ */ React2.createElement(RotateIcon, null)), /* @__PURE__ */ React2.createElement("a", {
    onClick: onClose
  }, /* @__PURE__ */ React2.createElement(CloseIcon, null))), alt && /* @__PURE__ */ React2.createElement("span", {
    className: "__react_modal_image__caption"
  }, alt));
};
var Header_default = Header;

// ../../node_modules/.pnpm/react-modal-image@2.6.0/node_modules/react-modal-image/es/Image.js
...
var Image = /* @__PURE__ */ function(_Component) {
  ...
  _createClass2(Image2, [{
    ...
    value: function render() {
      ...
      return /* @__PURE__ */ React3.createElement("div", null, this.state.loading && /* @__PURE__ */ React3.createElement(SpinnerIcon2, null), /* @__PURE__ */ React3.createElement("img", {
        id,
        className,
        src,
        style,
...
var Lightbox = /* @__PURE__ */ function(_Component) {
  ...
  _createClass3(Lightbox2, [{
    ...
    value: function render() {
      ...
      return /* @__PURE__ */ React4.createElement("div", null, /* @__PURE__ */ React4.createElement(StyleInjector, {
      ...
      }, zoomed && /* @__PURE__ */ React4.createElement(Image, {
      ...
      })), /* @__PURE__ */ React4.createElement(Header_default, {
        image: large || medium,
        alt,
        zoomed,
...
var _default = /* @__PURE__ */ function(_Component) {
  ...
  _createClass4(_default2, [{
    ...
    value: function render() {
      ...
      return /* @__PURE__ */ React5.createElement("div", null, /* @__PURE__ */ React5.createElement("img", {
        className,
        style: {
          cursor: "pointer",
          maxWidth: "100%",
        ...
        srcSet: smallSrcSet,
        alt
      }), modalOpen && /* @__PURE__ */ React5.createElement(Lightbox, {
        medium,
        large,
        alt,
...
var HelpWinSWR = ({ val }) => {
  ...
  if (error) {
    return /* @__PURE__ */ jsx27("p", { children: "error" });
  } else if (isLoading) {
    return /* @__PURE__ */ jsx27("p", { children: "isloading" });
  }
  if (data) {
    console.log(data);
  }
  const options = {
    replace(domNode) {
      if (domNode instanceof Element && domNode.attribs && domNode.name && domNode.name === "img") {
        ...
        return /* @__PURE__ */ jsx27("div", { children: /* @__PURE__ */ jsx27(_default, { small: props.src, large: props.src }) });
      }
    }
  };
  return /* @__PURE__ */ jsx27("div", { children: parse(data.q, options) });
};
var HelpWin = ({ chartName, children }) => {
  const HWDirContext = useHWContext();
  return /* @__PURE__ */ jsx27("div", { className: "nx-sticky nx-pointer-events-none -nx-mt-96 nx-bottom-0 nx-w-full nx-flex nx-h-full nx-justify-end nx-p-4", children: /* @__PURE__ */ jsxs18("div", { id: "helpwin", className: "nx-rounded-md nx-h-96 nx-w-96 nx-p-4 nx-bg-gray-300 nx-resize nx-flex nx-flex-col nx-justify-between", children: [
    /* @__PURE__ */ jsxs18("div", { className: "nx-w-full nx-pointer-events-auto nx-h-2/3 nx-p-4 nx-text-blue-950 nx-fill-blue-500 nx-overflow-y-scroll", children: [
      children,
      /* @__PURE__ */ jsx27(HelpWinSWR, { val: HWDirContext.mdDir })
    ] }),
    /* @__PURE__ */ jsx27("div", { className: "nx-w-full nx-pointer-events-auto nx-flex nx-flex-row nx-bottom-0 nx-inset-x-0 nx-justify-start", children: HWDirContext.buttonState.map((b) => {
      return /* @__PURE__ */ jsx27("button", { onClick: b.onClick ? b.onClick : () => {
        console.log(`no action ${b.label}`);
      }, className: "nx-p-4 nx-rounded-md nx-fill-white nx-bg-blue-500 hover:nx-bg-blue-600 active:nx-bg-blue-700 nx-text-gray-200 nx-mr-4", children: b.label });
    }) })
  ] }) });
};
    ...
    () => (
      ...
      search ? matchSorter(directories, search, { keys: ["title"] }).map(
        ({ route, title }) => ({
          id: route + title,
          route,
          children: /* @__PURE__ */ jsx28(HighlightMatches, { value: title, match: search })
        })
      ) : []
    ),
    [search, directories]
...
var DEFAULT_THEME = {
  ...
  chat: {
    icon: /* @__PURE__ */ jsxs19(Fragment10, { children: [
      /* @__PURE__ */ jsx29(DiscordIcon, {}),
      /* @__PURE__ */ jsx29("span", { className: "nx-sr-only", children: "Discord" })
    ] })
  },
  darkMode: true,
  direction: "ltr",
  ...
  editLink: {
    component: function EditLink({ className, filePath, children }) {
      ...
      return /* @__PURE__ */ jsx29(Anchor, { className, href: editUrl, children });
    },
    text: "Edit this page"
  },
  feedback: {
  ...
  gitTimestamp: function GitTimestamp({ timestamp }) {
    ...
    return /* @__PURE__ */ jsxs19(Fragment10, { children: [
      "Last updated on",
      " ",
      /* @__PURE__ */ jsx29("time", { dateTime: timestamp.toISOString(), children: timestamp.toLocaleDateString(locale, {
        day: "numeric",
        month: "long",
        year: "numeric"
      }) })
  ...
  head: /* @__PURE__ */ jsxs19(Fragment10, { children: [
    /* @__PURE__ */ jsx29("meta", { name: "msapplication-TileColor", content: "#fff" }),
    /* @__PURE__ */ jsx29("meta", { httpEquiv: "Content-Language", content: "en" }),
    /* @__PURE__ */ jsx29("meta", { name: "description", content: "Nextra: the next docs builder" }),
    /* @__PURE__ */ jsx29("meta", { name: "twitter:card", content: "summary_large_image" }),
    /* @__PURE__ */ jsx29("meta", { name: "twitter:site", content: "@shuding_" }),
    /* @__PURE__ */ jsx29("meta", { property: "og:title", content: "Nextra: the next docs builder" }),
    /* @__PURE__ */ jsx29("meta", { property: "og:description", content: "Nextra: the next docs builder" }),
    /* @__PURE__ */ jsx29("meta", { name: "apple-mobile-web-app-title", content: "Nextra" })
  ] }),
  i18n: [],
  logo: /* @__PURE__ */ jsxs19(Fragment10, { children: [
    /* @__PURE__ */ jsx29("span", { className: "nx-font-extrabold", children: "Nextra" }),
    /* @__PURE__ */ jsx29("span", { className: "nx-ml-2 nx-hidden nx-font-normal nx-text-gray-600 md:nx-inline", children: "The Next Docs Builder" })
  ] }),
  logoLink: true,
  navbar: {
    component: Navbar
  ...
  project: {
    icon: /* @__PURE__ */ jsxs19(Fragment10, { children: [
      /* @__PURE__ */ jsx29(GitHubIcon, {}),
      /* @__PURE__ */ jsx29("span", { className: "nx-sr-only", children: "GitHub" })
    ] })
  },
  search: {
    component: function Search2({ className, directories }) {
      const config = useConfig();
      return config.flexsearch ? /* @__PURE__ */ jsx29(Flexsearch, { className }) : /* @__PURE__ */ jsx29(MatchSorterSearch, { className, directories });
    },
    emptyResult: /* @__PURE__ */ jsx29("span", { className: "nx-block nx-select-none nx-p-8 nx-text-center nx-text-sm nx-text-gray-400", children: "No results found." }),
  ...
  sidebar: {
    ...
    titleComponent: ({ title }) => /* @__PURE__ */ jsx29(Fragment10, { children: title }),
    toggleButton: false
  },
  themeSwitch: {
...
import { Children, cloneElement, useEffect as useEffect6, useRef as useRef8, useState as useState8 } from "react";
...
var Details = (_a) => {
  ...
  return /* @__PURE__ */ jsxs20(
    ...
    __spreadProps(__spreadValues(__spreadProps(__spreadValues({
      ...
      children: [
        /* @__PURE__ */ jsx30(DetailsProvider, { value: setOpen, children: summary }),
        /* @__PURE__ */ jsx30(Collapse, { isOpen: openState, children: restChildren })
      ]
    })
  );
};
...
var A = (_a) => {
  ...
  return /* @__PURE__ */ jsx30(Anchor, __spreadValues({ href, newWindow: EXTERNAL_HREF_REGEX.test(href) }, props));
};
var getComponents = ({
  isRawLayout,
  components
  ...
  return __spreadValues({
    h1: (props) => /* @__PURE__ */ jsx30(
      "h1",
      __spreadValues({
        className: "nx-mt-2 nx-text-4xl nx-font-bold nx-tracking-tight nx-text-slate-900 dark:nx-text-slate-100"
      }, props)
    ),
    h2: (props) => /* @__PURE__ */ jsx30(HeadingLink, __spreadValues({ tag: "h2", context }, props)),
    h3: (props) => /* @__PURE__ */ jsx30(HeadingLink, __spreadValues({ tag: "h3", context }, props)),
    h4: (props) => /* @__PURE__ */ jsx30(HeadingLink, __spreadValues({ tag: "h4", context }, props)),
    h5: (props) => /* @__PURE__ */ jsx30(HeadingLink, __spreadValues({ tag: "h5", context }, props)),
    h6: (props) => /* @__PURE__ */ jsx30(HeadingLink, __spreadValues({ tag: "h6", context }, props)),
    ul: (props) => /* @__PURE__ */ jsx30(
      "ul",
      __spreadValues({
        className: "nx-mt-6 nx-list-disc first:nx-mt-0 ltr:nx-ml-6 rtl:nx-mr-6"
      }, props)
    ),
    ol: (props) => /* @__PURE__ */ jsx30(
      "ol",
      __spreadValues({
        className: "nx-mt-6 nx-list-decimal first:nx-mt-0 ltr:nx-ml-6 rtl:nx-mr-6"
      }, props)
    ),
    li: (props) => /* @__PURE__ */ jsx30("li", __spreadValues({ className: "nx-my-2" }, props)),
    blockquote: (props) => /* @__PURE__ */ jsx30(
      "blockquote",
      __spreadValues({
        className: cn16(
    ...
    a: Link,
    table: (props) => /* @__PURE__ */ jsx30(
      Table,
      __spreadValues({
        className: "nextra-scrollbar nx-mt-6 nx-p-0 first:nx-mt-0"
      }, props)
    ),
    p: (props) => /* @__PURE__ */ jsx30("p", __spreadValues({ className: "nx-mt-6 nx-leading-7 first:nx-mt-0" }, props)),
    tr: Tr,
    th: Th,
    td: Td,
    details: Details,
...
var Body = ({
  ...
  if (themeContext.layout === "raw") {
    return /* @__PURE__ */ jsx31("div", { className: classes4.main, children });
  }
  const date = themeContext.timestamp && config.gitTimestamp && timestamp ? new Date(timestamp) : null;
  const gitTimestampEl = (
    // Because a user's time zone may be different from the server page
    mounted && date ? /* @__PURE__ */ jsx31("div", { className: "nx-mt-12 nx-mb-8 nx-block nx-text-xs nx-text-gray-500 ltr:nx-text-right rtl:nx-text-left dark:nx-text-gray-400", children: renderComponent(config.gitTimestamp, { timestamp: date }) }) : /* @__PURE__ */ jsx31("div", { className: "nx-mt-16" })
  );
  ...
  return /* @__PURE__ */ jsx31(
    "article",
    {
      ...
      children: /* @__PURE__ */ jsxs21("main", { className: "nx-w-full nx-min-w-0 nx-max-w-6xl nx-px-6 nx-pt-4 md:nx-px-12", children: [
        breadcrumb,
        body
      ] })
    }
...
var InnerLayout = ({
  ...
  const tocEl = activeType === "page" || !themeContext.toc || themeContext.layout !== "default" ? themeContext.layout !== "full" && themeContext.layout !== "raw" && /* @__PURE__ */ jsx31("nav", { className: classes4.toc, "aria-label": "table of contents" }) : /* @__PURE__ */ jsx31(
    "nav",
    {
  ...
  return (
    ...
    // `html` element.
    /* @__PURE__ */ jsxs21("div", { dir: direction, children: [
      /* @__PURE__ */ jsx31(
        "script",
        {
      ...
      /* @__PURE__ */ jsx31(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxs21(ActiveAnchorProvider, { children: [
            /* @__PURE__ */ jsx31(
              Sidebar,
              {
                docsDirectories,
            ...
            tocEl,
            /* @__PURE__ */ jsx31(SkipNavContent, {}),
            /* @__PURE__ */ jsx31(
              Body,
              {
                themeContext,
                breadcrumb: activeType !== "page" && themeContext.breadcrumb ? /* @__PURE__ */ jsx31(Breadcrumb, { activePath }) : null,
                timestamp,
                navigation: activeType !== "page" && themeContext.pagination ? /* @__PURE__ */ jsx31(
                  NavLinks,
                  {
...
function Layout(_a) {
  ...
  return /* @__PURE__ */ jsx31(HWContextProvider, { children: /* @__PURE__ */ jsx31(ConfigProvider, { value: context, children: /* @__PURE__ */ jsx31(InnerLayout, __spreadProps(__spreadValues({}, context.pageOpts), { children })) }) });
}
export {
  Bleed,
  Callout,
